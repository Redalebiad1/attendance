...
<form method="post" action="success.php">
    ...
    <div class="form-group">
        ...
        <select required class="form-control" id="specialty" name="specialty">
            <?php while($r=$results->fetch(PDO::FETCH_ASSOC)) { ?>
                <option value ="<?php echo $r['specialty_id'] ?>"><?php echo $r['name'] ?></otion>
    ...
    <div class="form-group">
        ...
        <input required type="text" class="form-control" id="phonenum" name="phonenum" aria-describedby="phoneHelp">
